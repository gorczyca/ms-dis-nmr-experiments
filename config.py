...
CONFIG['msdis-st']['hpc'] = '/data/horse/ws/pigo271b-nmr/nmr-exp/conda_envs/msdis_env/bin/python /data/horse/ws/pigo271b-nmr/nmr-exp/dependencies/solvers/MS-DIS/msdis.py -p {instance} -b "tt(ts). at(ds)." -f aba'
